...
\vspace{-0.2cm}
\fontsize{0.3cm}{0.5cm}\selectfont \bfseries \textsc{\color{bluePoli} Dr. Rogelio Hasimoto Beltrán \\ \course}\\
...
\noindent \textbf{\color{bluePoli} Resumen:} {\abstract}
\end{minipage}
\end{center}
